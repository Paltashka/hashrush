...
const ChooseHero = () => {
    return (
        <div className="choose-hero">
            <div className='choose-hero__background'>
                <div className="choose-hero__title">
                    <h1 className="heading">Choose your hero</h1>
                    <p className="choose-hero__title__text">
                        Be the first to claim a powerful hero to bolster your forces with their abilities and tougher
                        stats. There are many heroes in the Hermeian Galaxy each with their own set of skills and buffs
                        that can help your other units on the battlefield to perform better.
                    </p>
