    ...
    return (
        <div className="thanks">
            ...
            <span className="button">
              ...
              <span className="button__text-visible" style={{
                  color: 'white',
                  fontWeight: '700',
                  ...
                  letterSpacing: '0.42px'
                    ...
                    <div className="account__button">
                        ...
                        <a href="http://discord.gg/4YMBHbw" target="_blank"><span className="account__text"
                                                                                  style={{fontWeight: '700'}}>we are here to help</span></a>
